                      ...
                      },
                      {
                      ...
                      },
                       {
                          ...
                          "function": {
                              ...
                              "description": """
                              Retorna dados com LINK para consulta para agendar uma consulta com o dentista caso não tenha fornecido o nome e/ou a especialidade fornecida e/ou procedimento fornecido e se a função retornar 'No  records found' significa que não foi encontrado nenhum dado no banco de dados. Caso a mensagem tenha marcação de tempo como 'hoje', 'semana que vem', entre outros, retornar link para consulta"""
                          }
                      },
                      {
                          "type": "function",
